...
class SupplierDialog extends React.Component {
  ...
  render() {
    ...
    let columns = [
      { title: "menu.name", field: "name", width: "150",
      headerStyle: {
        minWidth:"150px",
        paddingLeft: "10px",
        paddingRight: "0px",
      ...
      { title:"menu.code", field: "code", align: "left", width: "150",
      headerStyle: {
        minWidth:"150px",
        paddingLeft: "10px",
        paddingRight: "0px",
    ...
    return (
      ...
      >
        ...
        <DialogTitle style={{ cursor: "move" }} id="draggable-dialog-title">
          <span className="mb-20 styleColor"> {(id ? "update" : "Add")} </span>
            ...
            <Grid className="" container spacing={2}>
              <Grid item lg={6} md={6} sm={12} xs={12}>
                ...
                >
                  ...
                  <TextValidator
                    ...
                    // style ={{width:"75%"}}
                    size="small"
                    label = {<span className="font">"menu.parent"</span>}
                    variant="outlined"
                    type="text"
              ...
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <TextValidator
                  ...
                  value={name}
                  validators={["required"]}
                  errorMessages={["general.errorMessages_required"]}
                />
              </Grid>
              <Grid item lg={6} md={6} sm={12} xs={12}>
                <TextValidator
                  ...
                  <Autocomplete
                    ...
                    renderInput={params => (
                      <TextValidator
                        ...
                        fullWidth
                        validators={["required"]}
                        errorMessages={["user.please_select_permission"]}
                      />
                    )}
                  />
                )}
